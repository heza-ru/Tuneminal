...
- `IRIS_OUT.mp3` - Sample audio file
- `IRIS_OUT.lrc` - Synchronized lyrics
- `Kenshi Yonezu - IRIS OUT.mp3` - Another sample
- `Kenshi Yonezu - IRIS OUT.lrc` - Corresponding lyrics
